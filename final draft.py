...
class MultiplicationApp:
    def __init__(self, root):
        ...
        # Initialise default colour theme
        self.bg_colour = "white"
        self.fg_colour = "black"
        
        # Theme colors dictionary
        self.theme_colors = {
            "High Contrast": {"bg": "black", "fg": "white"},
            "Dark Mode": {"bg": "gray20", "fg": "white"},
            "Default": {"bg": "white", "fg": "black"},
            "Blue": {"bg": "light blue", "fg": "black"},
            "Red": {"bg": "light coral", "fg": "black"},
            "Green": {"bg": "light green", "fg": "black"},
        }
    ...
    def apply_settings(self):
        # Apply the current font and colour settings to all widgets
        for widget in self.all_widgets:
            try:
                ...
                pass
            try:
                widget.config(bg=self.bg_colour, fg=self.fg_colour)
            except tk.TclError:
                pass
    ...
    def change_theme(self, theme_name):
        ...
        if theme:
            self.bg_colour = theme["bg"]
            self.fg_colour = theme["fg"]
            self.apply_settings()
    ...
    def generate_questions(self, start, end):
        # Generate a set of multiplication questions
        for _ in range(10):
    ...
    def show_next_question(self):
        # Show the next question or the final score if done
